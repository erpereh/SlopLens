...
function MobileSidebar({
  ...
  return createPortal(
    <div
      className={cn(
        "pointer-events-none fixed left-0 top-0 z-50 size-0 xl:hidden",
  ...
  function AnimatedSidebar(
    ...
    return (
      <motion.aside
        ...
        style={style}
        className={cn(
          "group/sidebar relative hidden h-auto shrink-0 xl:block will-change-[width]",
          "peer",
  ...
  function AnimatedSidebarRail({ className, onClick, type = "button", ...props }, forwardedRef) {
    ...
    return (
      <button
        ...
        className={cn(
          "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 outline-none xl:block",
    ...
    return (
      <motion.main
        ...
        className={cn(
          ...
          "xl:peer-data-[variant=inset]:m-2 xl:peer-data-[variant=inset]:ml-0 xl:peer-data-[variant=inset]:rounded-2xl xl:peer-data-[variant=inset]:shadow-sm",
          className,
        )}
      />
    );
